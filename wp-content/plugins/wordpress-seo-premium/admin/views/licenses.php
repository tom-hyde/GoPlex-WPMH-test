		...
		<section class="yoast-seo-premium-extension">
			...
			<?php if ( $extension_list->is_installed( $extension->get_title() ) ) : ?>
				...
				<?php if ( $extensions->is_activated( 'wordpress-seo-premium' ) ) : ?>
					...
					<a target="_blank" href="<?php WPSEO_Shortlinker::show( 'https://www.gpltimes.com' ); ?>" class="yoast-link--license"><?php esc_html_e( 'Manage your subscription', 'wordpress-seo' ); ?></a>
				<?php else : ?>
					...
					<div class="yoast-button-container">
						<?php if ( $extension_list->is_installed( $extension->get_title() ) ) : ?>
							...
							<?php if ( $extensions->is_activated( $id ) ) : ?>
								<div class="yoast-button yoast-button--noarrow yoast-button--extension yoast-button--extension-activated"><?php esc_html_e( 'Activated', 'wordpress-seo' ); ?></div>
								<a target="_blank" href="<?php WPSEO_Shortlinker::show( 'https://www.gpltimes.com/my-account/' ); ?>" class="yoast-link--license"><?php esc_html_e( 'Manage your subscription on My Yoast', 'wordpress-seo' ); ?></a>
							<?php else : ?>
								<div class="yoast-button yoast-button--noarrow yoast-button--extension yoast-button--extension-activated"><?php esc_html_e( 'Activated', 'wordpress-seo' ); ?></div>
								<a target="_blank" href="<?php WPSEO_Shortlinker::show( 'https://www.gpltimes.com/my-account/' ); ?>" class="yoast-link--license"><?php esc_html_e( 'Manage your subscription', 'wordpress-seo' ); ?></a>
							<?php endif; ?>
						<?php else : ?>
