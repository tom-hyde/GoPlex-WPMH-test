...
class Vc_Frontend_Editor {
	...
	public function toString( $shortcode, $content ) {
		...
		// START UNCODE EDIT
		$output = sprintf( '<div class="vc_element" data-tag="%s" data-shortcode-controls="%s" data-model-id="%s">%s[%s %s]%s[/%s]%s', esc_attr( $shortcode['tag'] ), esc_attr( wp_json_encode( $shortcode_obj->shortcodeClass()
		// original:
